...
camera_config_t esp32cam_aithinker_config{
    ...
    .pixel_format = PIXFORMAT_JPEG,
    .frame_size = FRAMESIZE_VGA, //640x480 20hz
    //.frame_size = FRAMESIZE_SVGA, //800x600 20hz
    // .frame_size = FRAMESIZE_XGA, //1024x768 10hz needs 96K or even smaller FRAMESIZE_SVGA - can work if using only 1 fb
    //.frame_size = FRAMESIZE_HD, //1280x720 10hz
